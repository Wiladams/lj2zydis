...
local ZydisFormatter = require("lj2zydis.ZydisFormatter")
local ZydisDecoder = require("lj2zydis.ZydisDecoder")
...
local function main()
    ...
    local decoder = ZydisDecoder(ffi.C.ZYDIS_MACHINE_MODE_LONG_64, ffi.C.ZYDIS_ADDRESS_WIDTH_64);
    local formatter = ZydisFormatter();
